...
class CRUDBase:
    """Базовый класс, реализующий стандартные CRUD-операции."""
    ...
    async def get(
        ...
        """Получить экземпляр модели по её ID."""
    ...
    async def get_multi(
        ...
        """Получить список экземпляров модели."""
    ...
    async def update(
        ...
        """Частично обновить запись модели в базе данных."""
    ...
    async def remove(
        ...
        """Удалить экземпляр модели из БД."""
